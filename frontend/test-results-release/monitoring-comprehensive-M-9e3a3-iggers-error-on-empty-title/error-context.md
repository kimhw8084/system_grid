...
- Name: monitoring-comprehensive.spec.ts >> Monitoring Comprehensive Functional Coverage >> Validation: Triggers error on empty title
- Location: tests/monitoring-comprehensive.spec.ts:32:3

# Error details

```
Error: Ambiguous button /Add Monitoring/i: found 2 visible, enabled matches
```
    ...
    - main [ref=e154]:
      ...
      - generic [ref=e1228]:
        - generic [ref=e1229]:
          - generic [ref=e1230]:
            - img [ref=e1231]
            - generic [ref=e1234]: "YOUR TIME (America/Chicago): 01:30:46"
          - generic [ref=e1235]:
            - img [ref=e1236]
            - generic [ref=e1239]: "SOUTH KOREA (KST): 15:30:46"
