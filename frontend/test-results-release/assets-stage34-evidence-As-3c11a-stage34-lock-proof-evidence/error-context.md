...
- Name: assets-stage34-evidence.spec.ts >> Assets Stage 34 evidence capture >> captures stage34 lock-proof evidence
- Location: tests/assets-stage34-evidence.spec.ts:710:3
  ...
  - main [ref=e154]:
      ...
      - generic [ref=e206]:
        ...
        - generic [ref=e218]:
          ...
          - generic [ref=e241]:
            ...
            - generic [ref=e244]:
              - button "Existing (414)" [ref=e245] [cursor=pointer]
              - button "Purged (2)" [ref=e246] [cursor=pointer]
      - generic [ref=e248]:
        - generic [ref=e249]:
          - generic [ref=e250]:
            - img
            - textbox "Scan asset matrix..." [active] [ref=e251]: PW-SYS-1784873900913-ed743q
          - generic [ref=e252]:
          ...
          - rowgroup [ref=e352]:
            - row "Action" [ref=e353]:
              - columnheader "Action" [ref=e354]:
                ...
                - generic: 
          - rowgroup [ref=e356]:
            - row "Press Space to toggle row selection (unchecked)  414 PW-ASSET-A-1784873900913-ed743q" [ref=e357]:
              - gridcell "Press Space to toggle row selection (unchecked) " [ref=e358]:
                ...
                - text: 
              - gridcell "414" [ref=e360]
              - gridcell "PW-ASSET-A-1784873900913-ed743q" [ref=e361]:
                - generic [ref=e362]: PW-ASSET-A-1784873900913-ed743q
            - row "Press Space to toggle row selection (unchecked)  415 PW-ASSET-B-1784873900913-ed743q" [ref=e363]:
              - gridcell "Press Space to toggle row selection (unchecked) " [ref=e364]:
                ...
                - text: 
              - gridcell "415" [ref=e366]
              - gridcell "PW-ASSET-B-1784873900913-ed743q" [ref=e367]:
                - generic [ref=e368]: PW-ASSET-B-1784873900913-ed743q
            - row "Press Space to toggle row selection (unchecked)  416 PW-ASSET-C-1784873900913-ed743q" [ref=e369]:
              - gridcell "Press Space to toggle row selection (unchecked) " [ref=e370]:
                ...
                - text: 
              - gridcell "416" [ref=e372]
              - gridcell "PW-ASSET-C-1784873900913-ed743q" [ref=e373]:
                - generic [ref=e374]: PW-ASSET-C-1784873900913-ed743q
          - rowgroup [ref=e375]:
            - row "PW-SYS-1784873900913-ed743q Physical Maintenance Production Unowned N/A" [ref=e376]:
              - gridcell "PW-SYS-1784873900913-ed743q" [ref=e377]:
                - generic [ref=e378]: PW-SYS-1784873900913-ed743q
            ...
            - row "PW-SYS-1784873900913-ed743q Physical Active DR admin_root N/A" [ref=e390]:
              - gridcell "PW-SYS-1784873900913-ed743q" [ref=e391]:
                - generic [ref=e392]: PW-SYS-1784873900913-ed743q
            ...
            - row "PW-SYS-1784873900913-ed743q Physical Active Prod admin_root N/A" [ref=e404]:
              - gridcell "PW-SYS-1784873900913-ed743q" [ref=e405]:
                - generic [ref=e406]: PW-SYS-1784873900913-ed743q
    ...
    - generic [ref=e479]:
      - generic [ref=e480]:
        - generic [ref=e481]:
          - img [ref=e482]
          - generic [ref=e485]: "YOUR TIME (America/Chicago): 01:21:20"
        - generic [ref=e486]:
          - img [ref=e487]
          - generic [ref=e490]: "SOUTH KOREA (KST): 15:21:20"
...
```ts
  ...
  551 |   
  552 |   const selectionBadge = page.locator('div').filter({ text: /selected/i }).first()
  553 |   const selectionBadgeVisible = await selectionBadge.isVisible({ timeout: 2000 }).catch(() => false)
  554 |   attempts.push(`selectionBadgeVisible=${String(selectionBadgeVisible)}`)
  555 |   
  556 |   console.log(`[Interaction] Row click result: selectedCount=${selectedRowCount}, badgeVisible=${selectionBadgeVisible}`)
  557 |   return {
  558 |     verdict: selectedRowCount > 0 ? 'pass' : 'fail',
  559 |     attempts,
  560 |     bounds: toRect(await firstRow.boundingBox()),
  561 |     details: {
  562 |       selectedRowCount,
  563 |       selectionBadgeVisible,
  564 |       selectedText: await interactionCell.textContent(),
  565 |     },
  566 |   } satisfies InteractionProof
  567 | }
  568 | 
  569 | const captureAssetQuickLook = async (page: any) => {
  570 |   const attempts: string[] = []
  571 |   console.log(`[Interaction] Starting quick-look panel capture`)
  572 |   attempts.push('click explicit quick-look trigger')
> 573 |   await page.getByTitle('Open quick look').first().click({ force: true })
      |                                                    ^ Error: locator.click: Test timeout of 180000ms exceeded.
  574 |   const quickLookButton = page.getByRole('button', { name: 'Engage Full Configuration' })
  575 |   const opened = await quickLookButton.isVisible({ timeout: 5_000 }).catch(() => false)
  576 |   attempts.push(opened ? 'quick-look panel visible' : 'quick-look panel not visible')
  577 |   const bounds = opened
  578 |     ? await quickLookButton.evaluate((node) => {
  579 |         const panel = node.closest('.fixed') as HTMLElement | null
  580 |         const rect = panel?.getBoundingClientRect()
  581 |         return rect ? { x: rect.x, y: rect.y, width: rect.width, height: rect.height } : null
  582 |       })
  583 |     : null
  584 |   console.log(`[Interaction] Quick look result: ${opened ? 'pass' : 'fail'}`)
  585 |   return {
  586 |     verdict: opened ? 'pass' : 'fail',
  587 |     attempts,
  588 |     bounds: toRect(bounds),
  589 |     details: { opened },
  590 |   } satisfies InteractionProof
  591 | }
  592 | 
  593 | const captureAssetDetails = async (page: any, detailPath: string, recordText: string) => {
  594 |   const attempts: string[] = []
  595 |   console.log(`[Interaction] Starting details modal capture`)
  596 |   attempts.push(`goto ${detailPath}`)
  597 |   await page.goto(detailPath)
  598 |   await expect(page.getByText(recordText).first()).toBeVisible({ timeout: 20_000 })
  599 |   const dialog = page.getByRole('dialog')
  600 |   let opened = await dialog.isVisible({ timeout: 5_000 }).catch(() => false)
  601 |   if (!opened) {
  602 |     attempts.push('detail route did not show dialog; retry via row double-click')
  603 |     await page.goto('/asset')
  604 |     await ensureWorkspaceVisible(page, 'Assets')
  605 |     await fillGridSearch(page, 'Scan asset matrix...', recordText)
  606 |     await page.locator('.ag-center-cols-container .ag-row').first().dblclick()
  607 |     opened = await dialog.isVisible({ timeout: 5_000 }).catch(() => false)
  608 |   }
  609 |   attempts.push(opened ? 'details dialog visible' : 'details dialog not visible')
  610 |   console.log(`[Interaction] Details dialog result: ${opened ? 'pass' : 'fail'}`)
  611 |   return {
  612 |     verdict: opened ? 'pass' : 'fail',
  613 |     attempts,
  614 |     bounds: toRect(opened ? await dialog.boundingBox() : null),
  615 |     details: { opened },
  616 |   } satisfies InteractionProof
  617 | }
  618 | 
  619 | const captureDirtyStateProof = async (page: any, dirtyValue: string) => {
  620 |   const attempts: string[] = []
  621 |   console.log(`[Interaction] Starting dirty state behavior capture`)
  622 |   await page.goto('/asset')
  623 |   await ensureWorkspaceVisible(page, 'Assets')
  624 |   attempts.push('open asset form from canonical /asset toolbar')
  625 |   await clickResilientButton(page, 'Add Asset')
  626 |   const dialog = page.getByRole('dialog')
  627 |   await expect(dialog).toBeVisible({ timeout: 5_000 })
  628 |   const formInput = dialog.locator('input').first()
  629 |   attempts.push('edit first asset form input to create dirty state')
  630 |   await formInput.fill(dirtyValue)
  631 |   attempts.push('press Escape to request close while dirty')
  632 |   await page.keyboard.press('Escape')
  633 |   const dirtyPrompt = page.getByText('Discard Asset Changes?')
  634 |   const guardPresented = await dirtyPrompt.isVisible({ timeout: 5_000 }).catch(() => false)
  635 |   const dialogStillOpen = await dialog.isVisible({ timeout: 5_000 }).catch(() => false)
  636 |   attempts.push(guardPresented ? 'dirty guard prompt visible' : 'dirty guard prompt missing')
  637 |   attempts.push(dialogStillOpen ? 'asset modal remained open while prompt displayed' : 'asset modal closed unexpectedly')
  638 |   console.log(`[Interaction] Dirty state guard result: guardPresented=${guardPresented}, modalStillOpen=${dialogStillOpen}`)
  639 |   return {
  640 |     verdict: guardPresented && dialogStillOpen ? 'pass' : 'fail',
  641 |     attempts,
  642 |     guardPresented,
  643 |     dialogStillOpen,
  644 |     promptBounds: toRect(guardPresented ? await dirtyPrompt.boundingBox() : null),
  645 |     modalBounds: toRect(dialogStillOpen ? await dialog.boundingBox() : null),
  646 |   } satisfies DirtyStateProof
  647 | }
  648 | 
  649 | const attachRouteScopedListeners = (page: any, sink: RuntimeEvent[]) => {
  650 |   const consoleListener = (message: any) => {
  651 |     if (message.type() !== 'warning' && message.type() !== 'error') return
  652 |     const location = message.location?.()
  653 |     sink.push({
  654 |       kind: 'console',
  655 |       channel: message.type(),
  656 |       text: message.text(),
  657 |       source: location?.url ? `${location.url}:${location.lineNumber ?? 0}` : null,
  658 |     })
  659 |   }
  660 |   const pageErrorListener = (error: Error) => {
  661 |     sink.push({
  662 |       kind: 'page-error',
  663 |       text: error.message,
  664 |       source: error.stack?.split('\n')[1]?.trim() ?? null,
  665 |     })
  666 |   }
  667 |   const requestFailedListener = (request: any) => {
  668 |     sink.push({
  669 |       kind: 'request-failure',
  670 |       url: request.url(),
  671 |       method: request.method(),
  672 |       resourceType: request.resourceType?.() ?? null,
  673 |       status: request.response()?.status?.() ?? null,
```