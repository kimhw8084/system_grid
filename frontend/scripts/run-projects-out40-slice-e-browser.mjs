...
try {
  ...
  const byMode = {
    rehearsal: ['playwright', 'test', 'tests/projects-out40-slice-e-timeline-dependency-a11y.spec.ts', '--grep', '@out40-slice-e-rehearsal', '--workers=1'],
    acceptance: ['playwright', 'test', 'tests/projects-out40-slice-e-timeline-dependency-a11y.spec.ts', '--grep', '@out40-slice-e-acceptance', '--workers=1'],
  }
  ...
  if (mode === 'regression') {
    ...
    for (const command of [sliceD, sliceC, scheduling, navigation, readability]) {
