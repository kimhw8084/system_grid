...
try {
  ...
  const byMode = {
    rehearsal: ['playwright', 'test', 'tests/projects-out40-slice-d-wbs-keyboard.spec.ts', '--grep', '@out40-slice-d-rehearsal', '--workers=1'],
    acceptance: ['playwright', 'test', 'tests/projects-out40-slice-d-wbs-keyboard.spec.ts', '--grep', '@out40-slice-d-acceptance', '--workers=1'],
  }
