...
import { WorkspaceEmptyState, WorkspaceFloatingPanel, useEscapeDismiss, useWorkspaceAnchoredLayer } from "../shared/OperationalWorkspacePrimitives";
...
export default function AssetGoldenOperationalWorkspace() {
  ...
  const rowActionSections = useMemo(() => {
    ...
    return buildAssetGoldenRowActionSections({
      asset: rowActionMenu.asset,
      activeTab,
      onOpenDetails: setActiveDetails,
      onOpenEdit: setActiveModal,
      onCloseMenu: () => setRowActionMenu(null),
      onOpenConfirm: openConfirm,
      onBulkAction: (payload) => bulkMutation.mutate(payload),
