...
const colors: any = {
  ...
  Existing: 'text-emerald-600 dark:text-emerald-400 border-emerald-500/20 bg-emerald-500/10 dark:bg-emerald-500/5',
  ...
  Warning: 'text-amber-600 dark:text-amber-400 border-amber-500/20 bg-amber-500/10 dark:bg-amber-500/5',
  Info: 'text-blue-600 dark:text-blue-400 border-blue-500/20 bg-blue-500/10 dark:bg-blue-500/5',
  ...
  // Project specific
  'Not Started': 'text-slate-600 dark:text-slate-400 border-slate-500/20 bg-slate-500/10 dark:bg-slate-500/5',
  'Planning': 'text-sky-600 dark:text-sky-400 border-sky-500/20 bg-sky-500/10 dark:bg-sky-500/5',
  'In Progress': 'text-blue-600 dark:text-blue-400 border-blue-500/20 bg-blue-500/10 dark:bg-blue-500/5',
  'Paused': 'text-amber-600 dark:text-amber-400 border-amber-500/20 bg-amber-500/10 dark:bg-amber-500/5',
  'Blocked': 'text-rose-600 dark:text-rose-400 border-rose-500/20 bg-rose-500/10 dark:bg-rose-500/5',
  ...
  'Review': 'text-indigo-600 dark:text-indigo-400 border-indigo-500/20 bg-indigo-500/10 dark:bg-indigo-500/5',
  'To Do': 'text-slate-600 dark:text-slate-400 border-slate-500/20 bg-slate-500/10 dark:bg-slate-500/5',
...
export const StatusPill = ({ value, fontSize }: { value: string, fontSize?: number }) => {
  ...
  return (
    <span 
      ...
      className={`inline-flex max-w-full min-w-0 items-center justify-center overflow-hidden whitespace-nowrap rounded-lg border px-2.5 py-0.5 text-ellipsis ${!fontSize ? 'text-[8px]' : ''} font-bold uppercase tracking-tighter transition-colors duration-500 ${colors[value] || colors[displayValue] || 'text-slate-600 dark:text-slate-400 border-slate-500/20 bg-slate-500/10 dark:bg-slate-500/5'}`}
    >
      {displayValue}
    </span>
  )
