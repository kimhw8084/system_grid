...
export const MONITORING_WORKSPACE_STANDARD: WorkspaceDefinition = {
  ...
  standardSurface: [
    ...
    'Add/edit workspace with sticky identity header, tabbed sections, collapsible cards, inline validation, and consistent action footer',
    'History, compare, and detail dossier flows for versioned operational records',
  ],
  requiredBaseline: [
