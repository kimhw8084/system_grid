  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center opacity-20 space-y-4">
          <Database size={64} />
          <p className="text-[10px] font-black uppercase tracking-[0.4em]">Control Plane Modules Transitioned to Local View Settings</p>
          <p className="text-[8px] font-bold text-slate-500 uppercase">Registry configuration is now available directly within each view via the gear icon.</p>
      </div>
