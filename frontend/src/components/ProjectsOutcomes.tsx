...
export default function ProjectsOutcomes() {
  ...
  return <main className="p09-page" data-workspace="projects" data-pv1-projects-route="true" data-p09-outcomes="true"><ProjectsOfflineNotice online={online} /><Header projectId={projectId} />
