...
dist/assets/index-CyMiRHTL.js   4,602.56 kB │ gzip: 1,219.58 kB
...
> vitest run
 ...
 Test Files  38 passed (38)
   ...
   Start at  21:02:38
   Duration  4.34s (transform 1.79s, setup 2.52s, import 5.18s, tests 2.86s, environment 24.87s)
```
...
Running 1 test using 1 worker
  ...
  ✓  1 tests/assets-workflows.spec.ts:8:3 › Assets workflows › simulates the changed Assets workflows end-to-end (22.8s)
SEED: Created monitoring item "PW-MON-1783476067166-kib906" (ID: 78)
