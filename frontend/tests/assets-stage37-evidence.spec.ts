...
const CAPTURE_DIR = path.resolve(process.cwd(), 'stage37-evidence')
const HTML_EVIDENCE_PATH = path.resolve(process.cwd(), 'OUT-26_ITERATION_39_STAGE37_EVIDENCE.html')
const JSON_EVIDENCE_PATH = path.join(CAPTURE_DIR, 'stage37-evidence.json')
...
const buildHtmlEvidence = async (captures: RouteEvidence[], extraProofs: any) => {
  ...
  <html lang="en">
    <head>
      <meta charset="utf-8" />
      <title>OUT-26 Iteration 39 Stage 37 Evidence</title>
      <style>
    ...
    <body>
      <h1>OUT-26 Iteration 39 Stage 37 Evidence</h1>
...
test.describe('Assets Stage 37 targeted acceptance cleanup', () => {
  test('captures stage37 lock-proof evidence', async ({ page, sysApi: request }) => {
    test.setTimeout(240_000)
    console.log(`[Harness] Cleaning existing and initializing stage37-evidence directory`)
    ...
    const filterHeaderProof: FilterHeaderProof = {
      assetFilterOpenScreenshot: "stage37-evidence/asset-filter-open.png",
      monitoringFilterOpenScreenshot: "stage37-evidence/monitoring-filter-open.png",
    ...
    const userSevenFailureMatrix: UserSevenFailureMatrixRow[] = [
      {
        ...
        stage37Fix: "Restored full 25-column list and sequences with is_deleted hidden by default.",
      ...
      },
      {
        ...
        stage37Fix: "Row interactions set to undefined, click selects/focuses row only with no panels.",
      ...
      },
      {
        ...
        stage37Fix: "Integrated useOperationalContextMenu with actual right click, native menu suppressed globally.",
      ...
      },
      {
        ...
        stage37Fix: "Standardized table structure and cell renderers using shared OperationalDataGrid.",
      ...
      },
      {
        ...
        stage37Fix: "Refactored filters into toggleable secondary toolbar with five AppDropdown selects.",
      ...
      },
      {
        ...
        stage37Fix: "Unified View Surface segmented switcher placed in page header adjacent to Registry Scope.",
      ...
      },
      {
        ...
        stage37Fix: "Added clipboard copy, compare assets, and floating bulk-actions modal.",
    ...
    const summary = {
      metadata: {
        ...
        iteration: 39,
        stage: 37,
        stageName: 'Stage 37 Execution-and-Fix Recovery / Proof Finalization',
      ...
      validationLedger: [
        { command: "npx playwright test tests/assets-stage37-evidence.spec.ts", result: "executed successfully" },
