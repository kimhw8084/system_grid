...
def seed():
    with Session(engine) as db:
        ...
        conns = [
            PortConnection(source_device_id=dev1.id,  source_port="eth0",   target_device_id=dev5.id,  target_port="Eth1/1",  purpose="Uplink",       speed_gbps=10,  unit="Gbps", direction="bidirectional", cable_type="SFP+ DAC"),
            PortConnection(source_device_id=dev2.id,  source_port="eth0",   target_device_id=dev5.id,  target_port="Eth1/2",  purpose="Uplink",       speed_gbps=10,  unit="Gbps", direction="bidirectional", cable_type="SFP+ DAC"),
            PortConnection(source_device_id=dev3.id,  source_port="bond0",  target_device_id=dev5.id,  target_port="Eth1/3",  purpose="DB traffic",   speed_gbps=25,  unit="Gbps", direction="bidirectional", cable_type="SFP28 DAC"),
            PortConnection(source_device_id=dev4.id,  source_port="bond0",  target_device_id=dev5.id,  target_port="Eth1/4",  purpose="DB traffic",   speed_gbps=25,  unit="Gbps", direction="bidirectional", cable_type="SFP28 DAC"),
            PortConnection(source_device_id=dev5.id,  source_port="Eth1/48",target_device_id=dev6.id,  target_port="eth1/1",  purpose="FW uplink",    speed_gbps=40,  unit="Gbps", direction="bidirectional", cable_type="QSFP+ DAC"),
            PortConnection(source_device_id=dev5.id,  source_port="Eth1/47",target_device_id=dev9.id,  target_port="1.1",     purpose="LB uplink",    speed_gbps=40,  unit="Gbps", direction="bidirectional", cable_type="QSFP+ DAC"),
            PortConnection(source_device_id=dev7.id,  source_port="e0a",    target_device_id=dev5.id,  target_port="Eth1/5",  purpose="NFS",          speed_gbps=25,  unit="Gbps", direction="bidirectional", cable_type="SFP28 MMF"),
            PortConnection(source_device_id=dev8.id,  source_port="vmnic0", target_device_id=dev5.id,  target_port="Eth1/6",  purpose="VM traffic",   speed_gbps=25,  unit="Gbps", direction="bidirectional", cable_type="SFP28 DAC"),
            PortConnection(source_device_id=dev14.id, source_port="vmnic0", target_device_id=dev5.id,  target_port="Eth1/7",  purpose="VM traffic",   speed_gbps=25,  unit="Gbps", direction="bidirectional", cable_type="SFP28 DAC"),
            PortConnection(source_device_id=dev15.id, source_port="eth0",   target_device_id=dev5.id,  target_port="Eth1/8",  purpose="Backup",       speed_gbps=10,  unit="Gbps", direction="bidirectional", cable_type="SFP+ SR"),
            PortConnection(source_device_id=dev10.id, source_port="eth0",   target_device_id=dev11.id, target_port="bond0",   purpose="DR replication",speed_gbps=10, unit="Gbps", direction="bidirectional", cable_type="SFP+ LR"),
            PortConnection(source_device_id=dev12.id, source_port="eth0",   target_device_id=dev17.id, target_port="Gi1/0/1", purpose="Lab access",   speed_gbps=1,   unit="Gbps", direction="bidirectional", cable_type="Cat6A"),
